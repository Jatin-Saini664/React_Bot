...
const Bot = () => {
    const [ishintGiven, setGivenHint] = useState(0);
    ...
    const options = [["0", "1", "2", "3"], ["Microsft", "Adobe", "Netscape", "IBM"]];
    const hints = ["id attribute is unique for every element.", "Netscape is developed Javascript."]
    ...
    function handleClick(e){
        ...
        let ros = id.split("-");
        let div = document.createElement("div");
        if(options[(Number)(ros[1])]===options[answer[(Number)(ros[0])]]){
            div.innerHTML="Correct Answer";
        }
        else if(ishintGiven==0){
            console.log(ishintGiven);
            setGivenHint(1);
        ...
        if(ishintGiven==1){
            ...
            ansDiv.className="right";
            ansDiv.innerHTML="Answer: "+options[answer[(Number)(ros[0])]];
            document.querySelector(".chat").append(ansDiv);
        }
